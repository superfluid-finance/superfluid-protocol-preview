...
// - and run: `npx truffle --network goerli exec ../test-scripts/setup-console.js`
...
module.exports = async function (callback) {
    ...
    try {
        ...
        // minting
        if (web3.utils.toBN(await daix.balanceOf(bob)).lt(web3.utils.toBN(minAmount))) {
        ...
        console.log("alice balance ", (await daix.balanceOf(alice)).toString());
        console.log("dan balance ", (await daix.balanceOf(dan)).toString());
